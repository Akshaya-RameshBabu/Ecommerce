...
<body>
  <!-- ======= Header ======= -->
  <header id="header" style="background-color: black;" class="">
    <div class="container d-flex align-items-center justify-content-lg-between">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li>
  <a class="nav-link" href="assets/pdf/Rgreen_ANIL-PRICE-LIST-2025.pdf" target="_blank" style="cursor:pointer;" onclick="window.open('assets/pdf/Rgreen_ANIL-PRICE-LIST-2025.pdf', '_blank'); return false;">
    Pricelist
  </a>
</li>
      ...
      <a href=" /index.php" class="get-started-btn scrollto">Order Now</a>
    </div>
  </header><!-- End Header -->
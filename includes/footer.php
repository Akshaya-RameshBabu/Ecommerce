...
<footer id="footer" class="bg-gradient-to-b from-gray-900 to-black text-white">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div class="space-y-6">
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        <h3 class="text-xl font-bold text-white">RGreen Crackers</h3>
                        <p class="text-red-400 text-sm">Celebrate Safely & Brightly</p>
                    </div>
                </div>
                <p class="text-gray-300 leading-relaxed text-sm">
                    Premium eco-friendly crackers for safe celebrations. Quality assured, 
                    environmentally conscious, and designed to make every festival memorable 
                    while caring for our planet.
                </p>
                <div class="flex items-center space-x-2 text-sm">
                    <span class="bg-green-600 text-white px-3 py-1 rounded-full">Made In India</span>
                    <span class="bg-blue-600 text-white px-3 py-1 rounded-full">Eco-Friendly</span>
                </div>
            </div>
            ...
            <div class="space-y-4">
                ...
                <ul class="space-y-3">
                    <li><a href="../index.php" class="text-gray-300 hover:text-red-400 transition-colors flex items-center space-x-2">
                        <span class="w-2 h-2 bg-red-500 rounded-full"></span>
                        <span>Home</span>
                    </a></li>
                  
                    <li><a href="..//SafetyTips.php" class="text-gray-300 hover:text-red-400 transition-colors flex items-center space-x-2">
                        <span class="w-2 h-2 bg-red-500 rounded-full"></span>
                        <span>Safety Guidelines</span>
                    </a></li>
                    <li><a href="..//ContactUs.php" class="text-gray-300 hover:text-red-400 transition-colors flex items-center space-x-2">
                        <span class="w-2 h-2 bg-red-500 rounded-full"></span>
                        <span>Contact Us</span>
                    </a></li>
                    <li><a href="./includes/About.php" class="text-gray-300 hover:text-red-400 transition-colors flex items-center space-x-2">
                        <span class="w-2 h-2 bg-red-500 rounded-full"></span>
                        <span>About Us</span>
                    </a></li>
            ...
            <div class="space-y-4">
                ...
                <div class="space-y-4">
                    <div class="flex items-start space-x-3">
                        ...
                        <div>
                            <p class="text-white font-medium">RGreen Crackers</p>
                            <p class="text-gray-300 text-sm"><?php echo nl2br(htmlspecialchars($address, ENT_QUOTES, 'UTF-8')); ?></p>
                            <p class="text-gray-400 text-xs">Fireworks Capital of India</p>
                        </div>
                    </div>
                    <div class="flex items-start space-x-3">
   ...
   <img src="./images/booknow.webp" alt="">
    ...
    <a href="https://wa.me/<?php echo preg_replace('/\D/', '', $phone2); ?>" 
       target="_blank" 
       class="block">
        <p class="text-white font-medium hover:text-green-400 transition">
    ...
    <p class="text-gray-300 text-sm">24/7 Contact Support</p>
                    ...
                    <div class="flex items-start space-x-3">
                        ...
                        <div>
                            <p class="text-white font-medium"><?php echo htmlspecialchars($email, ENT_QUOTES, 'UTF-8'); ?></p>
            ...
            <div class="space-y-4">
               ...
               <div class="flex space-x-4">
                    <a href="https://www.facebook.com/profile.php?id=61579694912040" class="bg-blue-600 hover:bg-blue-700 w-12 h-12 rounded-full flex items-center justify-center transition-colors" style="color:white" target="_blank">
                        <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                            <path d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z" />
                        </svg>
                    </a>
                  <a href="https://www.youtube.com/@RGreenCrackerss" target="_blank" 
   class="bg-red-600 hover:bg-red-700 w-12 h-12 rounded-full flex items-center justify-center transition-colors" style="color:white">
    <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
...
As per 2018 supreme court order, online sale of firecrackers are not permitted! We value our customers and at the same time, respect jurisdiction. We request you to add your products to the cart and submit the required crackers through the enquiry button. We will contact you within 24 hrs and confirm the order through WhatsApp or phone call. Please add and submit your enquiries and enjoy your Diwali with RGreen Enterprise. Our License No.----. RGreen Enterprise a company following 100% legal & statutory compliances and all our shops, go-downs are maintained as per the explosive acts. We send the parcels through registered and legal transport service providers as like every other major companies in Sivakasi is doing so.</h6>
            ...
            <div class="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
                <div class="text-center md:text-left">
                    <p class="text-gray-400 text-sm">
                        &copy; 2025 RGreen Crackers. All Rights Reserved.
                    </p>
    ...
    <div class="bg-gradient-to-r from-red-600 via-orange-500 to-red-600 py-3">
        <div class="text-center">
            <p class="text-white font-medium text-sm">
                🎆 Celebrate Responsibly • Light Up Safely • Spread Joy Everywhere! 🎆
            </p>
        </div>
    </div>
</footer>
